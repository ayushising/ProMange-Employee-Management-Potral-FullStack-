...
function PeersProfile() {
  ...
  const getpeersdata = () => {
    setempdata(datasent);
    setmanager(datasent.manager);
    setproject(datasent.project);
  };
  return (
    <div>
      <Navbar />
      <div className="items-center mt-20 ">
        <div className="flex text-4xl  justify-center ">
          <p className="mt-4">
            Your Profile{" "}
            <hr
              class="w-32 h-2 my-4  bg-red-700  border-0 rounded mt-1"
              style={{
                height: "3px",
                width: "12rem",
